...
describe('paymentRegisterUtils', () => {
  ...
  it('validatePaymentForm validates required fields', () => {
    ...
    expect(validatePaymentForm({ paymentStatus: 'BONUS', method: 'CASH', paymentAmount: '10', copaymentAmount: '' })).toBe('Cuando el estado es Bonificado, el medio debe ser Bonificado.')
    expect(validatePaymentForm({ paymentStatus: 'HEALTH INSURANCE', method: 'CASH', paymentAmount: '10', copaymentAmount: '0' })).toBe('Cuando el estado es Obra Social, el medio debe ser Obra Social.')
    expect(validatePaymentForm({ paymentStatus: 'PAID', method: 'BONUS', paymentAmount: '10', copaymentAmount: '' })).toBe('El medio Bonificado solo se permite con estado Bonificado.')
    expect(validatePaymentForm({ paymentStatus: 'PAID', method: 'HEALTH INSURANCE', paymentAmount: '10', copaymentAmount: '' })).toBe('El medio Obra Social solo se permite con estado Obra Social.')
