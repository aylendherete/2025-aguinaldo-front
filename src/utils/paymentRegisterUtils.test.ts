...
describe('paymentRegisterUtils', () => {
  ...
  it('validatePaymentForm validates required fields', () => {
    ...
    expect(validatePaymentForm({ paymentStatus: 'BONUS', method: 'CASH', paymentAmount: '10', copaymentAmount: '' })).toBe('El medio de pago debe ser Bonificado cuando el estado de pago es Bonificado.')
    expect(validatePaymentForm({ paymentStatus: 'HEALTH INSURANCE', method: 'CASH', paymentAmount: '10', copaymentAmount: '0' })).toBe('El medio de pago debe ser Obra Social cuando el estado de pago es Obra Social.')
    expect(validatePaymentForm({ paymentStatus: 'PAID', method: 'BONUS', paymentAmount: '10', copaymentAmount: '' })).toBe('El estado de pago debe ser Bonificado cuando el medio de pago es Bonificado.')
    expect(validatePaymentForm({ paymentStatus: 'PAID', method: 'HEALTH INSURANCE', paymentAmount: '10', copaymentAmount: '' })).toBe('El estado de pago debe ser Obra Social cuando el medio de pago es Obra Social.')
    expect(validatePaymentForm({ paymentStatus: 'PAID', method: 'CASH', paymentAmount: '', copaymentAmount: '' })).toBe('Ingresá el monto abonado.')
    expect(validatePaymentForm({ paymentStatus: 'PAID', method: 'CASH', paymentAmount: '0', copaymentAmount: '' })).toBe('El monto del pago debe ser mayor que cero.')
    expect(validatePaymentForm({ paymentStatus: 'PAID', method: 'CASH', paymentAmount: '-10', copaymentAmount: '' })).toBe('El monto del pago debe ser mayor que cero.')
    expect(validatePaymentForm({ paymentStatus: 'BONUS', method: 'BONUS', paymentAmount: '0', copaymentAmount: '' })).toBe('El monto del pago debe ser mayor que cero cuando el estado de pago es Bonificado.')
    expect(validatePaymentForm({ paymentStatus: 'BONUS', method: 'BONUS', paymentAmount: '-10', copaymentAmount: '' })).toBe('El monto del pago debe ser mayor que cero cuando el estado de pago es Bonificado.')
    expect(validatePaymentForm({ paymentStatus: 'PAID', method: 'CASH', paymentAmount: '10000000', copaymentAmount: '' })).toBe('El monto del pago debe ser menor que 10 millones.')
    expect(validatePaymentForm({ paymentStatus: 'PAID', method: 'CASH', paymentAmount: '10', copaymentAmount: '' })).toBeNull()
    expect(validatePaymentForm({ paymentStatus: 'PAID', method: 'CASH', paymentAmount: '1e309', copaymentAmount: '' })).toBe('Ingresá un monto abonado válido.')
    expect(validatePaymentForm({ paymentStatus: 'HEALTH INSURANCE', method: 'HEALTH INSURANCE', paymentAmount: '100', copaymentAmount: '' })).toBe('El copago es obligatorio y debe ser mayor o igual que cero cuando el estado de pago es Obra Social.')
    expect(validatePaymentForm({ paymentStatus: 'HEALTH INSURANCE', method: 'HEALTH INSURANCE', paymentAmount: '100', copaymentAmount: '-10' })).toBe('El copago es obligatorio y debe ser mayor o igual que cero cuando el estado de pago es Obra Social.')
    expect(validatePaymentForm({ paymentStatus: 'HEALTH INSURANCE', method: 'HEALTH INSURANCE', paymentAmount: '100', copaymentAmount: '0' })).toBeNull()
    expect(validatePaymentForm({ paymentStatus: 'HEALTH INSURANCE', method: 'HEALTH INSURANCE', paymentAmount: '100', copaymentAmount: '10000000' })).toBe('El copago debe ser menor que 10 millones.')
    ...
    expect(validatePaymentForm({ paymentStatus: 'HEALTH INSURANCE', method: 'HEALTH INSURANCE', paymentAmount: '100', copaymentAmount: '1e309' })).toBe('Ingresá un copago válido.')
    expect(validatePaymentForm({ paymentStatus: 'HEALTH INSURANCE', method: 'HEALTH INSURANCE', paymentAmount: '100', copaymentAmount: '120' })).toBe('El copago debe ser menor o igual al monto del pago.')
